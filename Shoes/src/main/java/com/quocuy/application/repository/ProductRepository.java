package com.quocuy.application.repository;

import com.quocuy.application.entity.Product;
import com.quocuy.application.model.dto.ChartDTO;
...
//    @Query(value = "SELECT NEW dto.model.com.quocuy.application.ProductInfoDTO(p.id, p.name, p.slug, p.price ,p.images ->> '$[0]', p.total_sold) " +
//            "FROM product p " +
//            "WHERE p.status = 1 " +
